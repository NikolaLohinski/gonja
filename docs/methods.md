...
There are differences in python versions. We try to capture this with ["dialects" and default to `3.11`](https://github.com/ardanlabs/gonja/blob/master/builtins/methods/pystring/dialect.go). Override the DefaultDialect to get the desired behavior.
