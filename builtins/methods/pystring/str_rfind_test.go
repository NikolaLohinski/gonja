...
var _ = Describe("RFind", func() {
	tests := []struct {
		...
		{input: "hello", substr: "hello", start: new(1), end: new(4), expected: -1}, // Substring not found within the specified range
		{input: "hello", substr: "ll", start: new(1), end: new(4), expected: 1},     // Substring found within the specified range
	}
